...
export default function Article2() {
  return (
    <ArticleShell label="Analyse" title="Les 10 signaux qui montrent que votre entreprise a besoin d&apos;un diagnostic" image="/images/gestion-dossiers.jpg" imageAlt="Dirigeante face &agrave; des piles de dossiers">
      ...
      <p>Vous consultez votre solde bancaire, vous savez que c&apos;est serr&eacute;, mais vous ne parvenez pas &agrave; distinguer ce qui rel&egrave;ve d&apos;un creux passager d&apos;un d&eacute;faut structurel. Le danger n&apos;est pas la tension elle-m&ecirc;me &mdash; c&apos;est l&apos;impossibilit&eacute; de savoir si vous &ecirc;tes en situation de risque r&eacute;el ou simplement dans un cycle normal. Et tant que vous ne le savez pas, chaque d&eacute;cision financi&egrave;re est un pari.</p>
      <h2>2. Un seul client repr&eacute;sente plus de 20 % de votre chiffre d&apos;affaires</h2>
      <p>Tant que ce client est l&agrave;, tout semble fonctionner. Le jour o&ugrave; il part &mdash; changement de prestataire, r&eacute;duction de budget, faillite &mdash; c&apos;est 20, 30, parfois 40 % de votre activit&eacute; qui dispara&icirc;t sans pr&eacute;venir. Combien de temps votre entreprise tiendrait-elle si cela arrivait demain matin ? La plupart des dirigeants &agrave; qui l&apos;on pose cette question ne connaissent pas la r&eacute;ponse.</p>
      <h2>3. Vous &ecirc;tes d&eacute;bord&eacute; mais votre chiffre d&apos;affaires stagne</h2>
      <p>Vos journ&eacute;es s&apos;allongent, vous n&apos;avez plus une minute pour vous, et pourtant le chiffre ne d&eacute;colle pas. Ce paradoxe est le signe le plus clair d&apos;un plafonnement. Les causes sont rarement l&agrave; o&ugrave; on les cherche, et elles se renforcent mutuellement si elles ne sont pas identifi&eacute;es &agrave; temps. Travailler plus n&apos;est pas la solution &mdash; c&apos;est souvent le sympt&ocirc;me.</p>
      <h2>4. Vous ne pourriez pas vous absenter une semaine</h2>
      <p>Si votre entreprise ne survit pas &agrave; une semaine sans vous, elle ne d&eacute;pend pas de votre &eacute;quipe &mdash; elle d&eacute;pend de vous. C&apos;est une fragilit&eacute; que beaucoup de dirigeants confondent avec de l&apos;engagement. Un accident, une maladie, un &eacute;puisement, et tout s&apos;arr&ecirc;te. Ce risque ne diminue pas avec le temps. Il augmente.</p>
      ...
      <p>Vos clients n&apos;entendent parler de vous que lorsque vous leur vendez quelque chose. Entre deux transactions, vous &ecirc;tes invisible. Pendant ce silence, vos concurrents occupent l&apos;espace, construisent leur notori&eacute;t&eacute;, et captent les clients qui auraient pu venir chez vous. L&apos;absence de communication n&apos;est pas neutre &mdash; c&apos;est un avantage offert &agrave; ceux qui communiquent.</p>
      <GoldSep />
      <h2>Ce que ces signaux ont en commun</h2>
      <p>Aucun n&apos;est fatal en soi. C&apos;est leur combinaison et leur dur&eacute;e qui cr&eacute;ent le danger. Un dirigeant qui cumule trois ou quatre de ces signaux dirige une entreprise qui fonctionne aujourd&apos;hui &mdash; mais qui s&apos;expose &agrave; des difficult&eacute;s dont il ne mesure pas encore l&apos;ampleur.</p>
      <ConversionBanner
        title="Vous vous reconnaissez dans ces signaux ?"
        text="Un diagnostic ATLAS les identifie, les quantifie et les transforme en plan d&apos;action concret et prioris&eacute;."
