...
export default function ArticleMicroEntreprise() {
  return (
    <ArticleShell label="Guide" title="Micro-entreprise : &agrave; quel moment passer de la survie &agrave; la strat&eacute;gie ?" image="/images/visio-domicile.jpg" imageAlt="Micro-entrepreneur en visioconf&eacute;rence depuis son domicile">
      ...
      <p>Le premier est le plafond invisible : votre chiffre d&apos;affaires stagne au m&ecirc;me niveau depuis deux ou trois ans, quels que soient vos efforts. Vous travaillez plus, vous gagnez pareil. Le deuxi&egrave;me est la saturation : votre agenda est plein, vous refusez des missions, et pourtant vos revenus restent fragiles, un mois creux et tout vacille. Le troisi&egrave;me est le plus sournois : vous ne savez plus si votre activit&eacute; est un vrai projet d&apos;entreprise ou un emploi que vous vous &ecirc;tes cr&eacute;&eacute;, sans cong&eacute;s pay&eacute;s et sans filet.</p>
      <p>Ces trois signes racontent la m&ecirc;me histoire : votre micro-entreprise a d&eacute;pass&eacute; la phase de lancement. Ce qui vous a permis de d&eacute;marrer, l&apos;&eacute;nergie, la d&eacute;brouille, le bouche-&agrave;-oreille, ne suffit plus pour franchir l&apos;&eacute;tape suivante.</p>
      <GoldSep />
      <h2>Ce qui arrive quand on ignore le cap</h2>
      <p>L&apos;ind&eacute;pendant qui ne se pose jamais la question strat&eacute;gique finit par la subir. Ses tarifs, fix&eacute;s au lancement pour d&eacute;crocher des clients, deviennent un boulet impossible &agrave; tra&icirc;ner, augmenter, c&apos;est risquer de perdre les clients historiques ; ne pas augmenter, c&apos;est s&apos;&eacute;puiser pour un revenu qui ne progresse pas. Sa d&eacute;pendance &agrave; deux ou trois donneurs d&apos;ordre s&apos;installe sans qu&apos;il s&apos;en rende compte. Les seuils du r&eacute;gime micro, les questions de <a href="https://www.urssaf.fr" target="_blank" rel="noopener">cotisations</a>, le passage &eacute;ventuel en soci&eacute;t&eacute; : autant de d&eacute;cisions structurantes repouss&eacute;es faute de visibilit&eacute;.</p>
      ...
      <ConversionBanner
        title="Franchir le cap avec m&eacute;thode"
        text="Structurer, embaucher, changer de r&eacute;gime : chacune de ces d&eacute;cisions m&eacute;rite d&apos;&ecirc;tre prise sur des donn&eacute;es, pas sur une intuition."
        stat="Diagnostic ATLAS Herm&egrave;s : 249 &euro;. Pens&eacute; pour les micro-entreprises."
      />
      <ArticleRelated items={[
        { label: "Analyse", title: "Seul &agrave; la t&ecirc;te de votre entreprise : comment prendre les bonnes d&eacute;cisions ?", href: "/articles/solitude-dirigeant-decisions" },
