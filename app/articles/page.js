...
export const metadata = {
  ...
  description: "Guides, analyses et ressources pour les dirigeants de TPE, PME et micro-entreprises. Diagnostic strat&eacute;gique, signaux d&apos;alerte, aides et accompagnement.",
};
      ...
      <div className="container">
        <section className="section" style={{ paddingTop: "20px" }}>
          <div className="articles-grid">
            ...
            <Card href="/articles/tresorerie-entreprises-rentables" img="/images/cheffe-cuisine.jpg" alt="Cheffe dans sa cuisine professionnelle" label="Analyse" title="Charges, tr&eacute;sorerie, impay&eacute;s : pourquoi des entreprises rentables finissent par fermer" desc="Le paradoxe qui frappe commerces, restaurants et artisans du b&acirc;timent, et les signaux qui l&apos;annoncent." />
            <Card href="/articles/solitude-dirigeant-decisions" img="/images/bureau-epure.jpg" alt="Bureau d&apos;un dirigeant seul" label="Analyse" title="Seul &agrave; la t&ecirc;te de votre entreprise : comment prendre les bonnes d&eacute;cisions ?" desc="L&apos;isolement du dirigeant est un risque strat&eacute;gique &agrave; part enti&egrave;re. Voici pourquoi, et pourquoi il s&apos;aggrave en silence." />
            <Card href="/articles/commerce-proximite-digital" img="/images/primeur-devanture.jpg" alt="Devanture d&apos;un commerce de proximit&eacute;" label="Analyse" title="Concurrence en ligne, avis Google : le commerce de proximit&eacute; peut-il encore gagner ?" desc="Le num&eacute;rique n&apos;a pas condamn&eacute; le commerce local. Mais il a chang&eacute; les r&egrave;gles, et beaucoup jouent encore avec les anciennes." />
            <Card href="/articles/croissance-rapide-piege" img="/images/chantier-ouvriers.jpg" alt="Ouvriers sur un chantier en pleine activit&eacute;" label="Analyse" title="Croissance rapide : le pi&egrave;ge qui tue autant d&apos;entreprises que la crise" desc="Carnet de commandes plein, embauches, nouveaux clients, et pourtant, c&apos;est souvent l&agrave; que tout bascule." />
          </div>
        </section>
      </div>
      <Footer />
