...
export default function ArticleCroissance() {
  return (
    <ArticleShell label="Analyse" title="Croissance rapide : le pi&egrave;ge qui tue autant d&apos;entreprises que la crise" image="/images/chantier-ouvriers.jpg" imageAlt="Ouvriers mobilis&eacute;s sur un chantier en pleine activit&eacute;">
      <p>Dans l&apos;imaginaire collectif, une entreprise meurt parce que les affaires vont mal. La r&eacute;alit&eacute; est plus d&eacute;routante : chaque ann&eacute;e, des entreprises en pleine croissance d&eacute;posent le bilan. Une entreprise du b&acirc;timent qui d&eacute;croche un chantier deux fois plus gros que d&apos;habitude. Un traiteur qui signe avec une grande enseigne. Un fabricant dont un produit d&eacute;colle. Six mois plus tard, l&apos;euphorie a laiss&eacute; place &agrave; la crise. Ce ph&eacute;nom&egrave;ne a un nom chez les analystes : la croissance non ma&icirc;tris&eacute;e, et elle figure parmi les premi&egrave;res causes de d&eacute;faillance des TPE et PME.</p>
      <GoldSep />
      <h2>Grandir co&ucirc;te de l&apos;argent avant d&apos;en rapporter</h2>
      <p>C&apos;est la m&eacute;canique que d&eacute;couvrent trop tard les dirigeants pi&eacute;g&eacute;s : chaque commande suppl&eacute;mentaire exige d&apos;avancer des achats, de la main-d&apos;&oelig;uvre, du stock, parfois du mat&eacute;riel, des semaines ou des mois avant d&apos;encaisser. Plus la croissance est rapide, plus le d&eacute;calage se creuse. L&apos;entreprise vend plus que jamais et n&apos;a jamais eu aussi peu de tr&eacute;sorerie. Un retard de paiement client, un impr&eacute;vu sur un chantier, et l&apos;&eacute;difice vacille.</p>
      <p>Le paradoxe est cruel : c&apos;est pr&eacute;cis&eacute;ment parce que tout va bien commercialement que personne ne voit venir le danger. Les voyants que regarde le dirigeant, commandes, chiffre d&apos;affaires, notori&eacute;t&eacute;, sont tous au vert. Ceux qui clignotent au rouge, besoin en fonds de roulement, marges r&eacute;elles, capacit&eacute; de production, sont ceux qu&apos;il n&apos;a pas le temps de suivre.</p>
      <GoldSep />
      <h2>La croissance casse ce qui faisait tenir l&apos;entreprise</h2>
      <p>Au-del&agrave; des chiffres, grandir vite met l&apos;organisation sous tension. Les processus informels qui suffisaient &agrave; cinq personnes s&apos;effondrent &agrave; douze. La qualit&eacute;, qui reposait sur l&apos;&oelig;il du dirigeant, se d&eacute;grade d&egrave;s qu&apos;il ne peut plus tout voir. Les recrutements faits dans l&apos;urgence fragilisent l&apos;&eacute;quipe historique. Les premiers clients, moins choy&eacute;s, commencent &agrave; regarder ailleurs. L&apos;entreprise grossit, mais ses fondations, elles, n&apos;ont pas &eacute;t&eacute; renforc&eacute;es pour porter le poids suppl&eacute;mentaire.</p>
      ...
      <ConversionBanner
        ...
        stat="Iris (599 &euro;) : diagnostic + suivi &agrave; 3 mois pour piloter votre croissance."
      />
      <ArticleRelated items={[
        ...
        { label: "Analyse", title: "D&eacute;pendre d&apos;un seul client : le danger silencieux qui menace les TPE et PME", href: "/articles/dependance-client-danger-silencieux" },
      ]} />
    </ArticleShell>
  );
}
