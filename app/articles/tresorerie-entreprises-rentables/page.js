...
export default function ArticleTresorerie() {
  return (
    <ArticleShell label="Analyse" title="Charges, tr&eacute;sorerie, impay&eacute;s : pourquoi des entreprises rentables finissent par fermer" image="/images/cheffe-cuisine.jpg" imageAlt="Cheffe concentr&eacute;e dans sa cuisine professionnelle">
      ...
      <p>En cas de tension aigu&euml;, des recours existent : la <a href="https://www.mediateur-des-entreprises.fr" target="_blank" rel="noopener">M&eacute;diation des entreprises</a> pour les litiges de paiement, les d&eacute;lais n&eacute;goci&eacute;s avec l&apos;<a href="https://www.urssaf.fr" target="_blank" rel="noopener">URSSAF</a>, les solutions de financement court terme de <a href="https://www.bpifrance.fr" target="_blank" rel="noopener">Bpifrance</a>. Ces dispositifs font gagner du temps. Ils ne r&eacute;pondent pas &agrave; la vraie question : pourquoi votre entreprise, rentable, se retrouve-t-elle r&eacute;guli&egrave;rement &agrave; court de liquidit&eacute;s ? Structure de co&ucirc;ts, conditions de r&egrave;glement, saisonnalit&eacute; mal anticip&eacute;e, prix mal calibr&eacute;s, croissance mal financ&eacute;e : les causes possibles sont nombreuses, souvent combin&eacute;es, et invisibles sans analyse compl&egrave;te.</p>
      <ConversionBanner
        title="Voir la tr&eacute;sorerie avant qu&apos;elle ne vous rattrape"
        text="Le diagnostic ATLAS mesure vos marges r&eacute;elles, votre besoin en fonds de roulement et votre r&eacute;silience financi&egrave;re."
        stat="Diagnostic complet &agrave; partir de 249 &euro;."
      />
      <ArticleRelated items={[
        ...
        { label: "Analyse", title: "Croissance rapide : le pi&egrave;ge qui tue autant d&apos;entreprises que la crise", href: "/articles/croissance-rapide-piege" },
      ]} />
    </ArticleShell>
  );
}
